...
// #define TILE_SIZE 32
//   __shared__ double Sz_shared[TILE_SIZE * TILE_SIZE];
//   __shared__ double Sh_shared[TILE_SIZE * TILE_SIZE];
  ...
  {
    if (i + Xi[n] >= This_tile_start_point_y && i + Xi[n] < Next_tile_start_point_y  && j + Xj[n] >= This_tile_start_point_x && j + Xj[n] < Next_tile_start_point_x) 
    {
...
//#define TS_WU 32
//__shared__ double Sf_shared[ADJACENT_CELLS * TS_WU * TS_WU];
